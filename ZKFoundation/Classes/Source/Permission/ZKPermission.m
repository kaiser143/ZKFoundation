    ...
    switch (type) {
        ...
        case ZKPermissionTypeLocationAlways: {
            if ([CLLocationManager locationServicesEnabled]) {
                ...
                if (type == ZKPermissionTypeLocationAlways) [locationManager requestAlwaysAuthorization];
                else if (type == ZKPermissionTypeLocationWhenInUse) [locationManager requestWhenInUseAuthorization];
